...
import sl.selene.module.impl.movement.JumpReset;
import sl.selene.module.impl.movement.NoLungeCooldown;
...
import sl.selene.module.impl.movement.WindCharge;
...
public class Manager {
   ...
   public Manager() {
      ...
      this.module.add(new JumpReset());
      this.module.add(new NoLungeCooldown());
      this.module.add(new WindCharge());
