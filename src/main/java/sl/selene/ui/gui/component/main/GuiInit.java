...
public class GuiInit extends GuiScreen {
   public static void init() {
      ...
      GuiScreen.settingsNavHover = new float[GuiScreen.SETTINGS_CATEGORIES.length];
      GuiScreen.tabHoverAnimations = new float[GuiScreen.TAB_COUNT];
      GuiScreen.tabPressValues = new float[GuiScreen.TAB_COUNT];
      GuiScreen.tabPressVelocity = new float[GuiScreen.TAB_COUNT];
      GuiScreen.contentAnimation.set(1.0);
      GuiScreen.configNavHover = new float[7];
      GuiScreen.selectedTab = GuiScreen.TAB_MODULES;
